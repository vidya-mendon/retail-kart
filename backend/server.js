...
var CONNECTION_URL = "mongodb+srv://vidya_1997:vidya_1997@cluster0-cfzyt.mongodb.net/test?retryWrites=true&w=majority"
const DATABASE_NAME = "RetailProject";
...
var BrandsController = require('./controller/AdminController');
app.use('/api/admin', BrandsController);

var RetailerController = require('./controller/ConsumerController');
app.use('/api/consumer', RetailerController);
